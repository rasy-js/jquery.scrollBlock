...
### footerHeight
`footerHeight` вычесть высоту футера, если наезжает
...
### query
`query` медиазапрос для инитиализации скрипта. Если true, то срабатывает при любом размере экрана. По умолчанию (>= 840).
